...
var Engine = function(boardSize, lightSquare, darkSquare, selectColor) {
  ...
  */
  ...
  const doublePawnPenalty = 10;
  const isolatedPawnPenalty = 20;
  const backwardPawnPenalty = 8;
  const passedPawnBonus = 20;
  const rookSemiOpenBonus = 10;
  const rookOpenBonus = 15
  ...
  const pstPawn = [
     ...
     4,   8,  12,  16,  16,  12,   8,   4,   o, o, o, o, o, o, o, o,
     3,   6,   9,  12,  12,   9,   6,   3,   o, o, o, o, o, o, o, o,
     2,   4,   6,   8,   8,   6,   4,   2,   o, o, o, o, o, o, o, o,
     1,   2,   3, -10, -10,   3,   2,   1,   o, o, o, o, o, o, o, o,       
     0,   0,   0, -40, -40,   0,   0,   0,   o, o, o, o, o, o, o, o,
     0,   0,   0,   0,   0,   0,   0,   0,   o, o, o, o, o, o, o, o
  ];
  ...
  const pstKnight = [
   ...
   -10,   0,   5,   5,   5,   5,   0, -10,   o, o, o, o, o, o, o, o,
   -10,   0,   0,   0,   0,   0,   0, -10,   o, o, o, o, o, o, o, o,
   -10, -30, -10, -10, -10, -10, -30, -10,   o, o, o, o, o, o, o, o
  ];
  ...
  const pstBishop = [
   ...
   -10,   0,   5,   5,   5,   5,   0, -10,   o, o, o, o, o, o, o, o,
   -10,   0,   0,   0,   0,   0,   0, -10,   o, o, o, o, o, o, o, o,
   -10, -10, -20, -10, -10, -20, -10, -10,   o, o, o, o, o, o, o, o
  ];
  ...
  const pstKing = [
    ...
    [
      ...
      -40, -40, -40, -40, -40, -40, -40, -40,   o, o, o, o, o, o, o, o,
      -20, -20, -20, -20, -20, -20, -20, -20,   o, o, o, o, o, o, o, o,
        0,  20,  40, -20,   0, -20,  40,  20,   o, o, o, o, o, o, o, o
    ],

    // endgame
    [
       0,  10,  20,  30,  30,  20,  10,   0,   o, o, o, o, o, o, o, o,
      10,  20,  30,  40,  40,  30,  20,  10,   o, o, o, o, o, o, o, o,
      20,  30,  40,  50,  50,  40,  30,  20,   o, o, o, o, o, o, o, o,
      30,  40,  50,  60,  60,  50,  40,  30,   o, o, o, o, o, o, o, o,
      30,  40,  50,  60,  60,  50,  40,  30,   o, o, o, o, o, o, o, o,
      20,  30,  40,  50,  50,  40,  30,  20,   o, o, o, o, o, o, o, o,
      10,  20,  30,  40,  40,  30,  20,  10,   o, o, o, o, o, o, o, o,
       0,  10,  20,  30,  30,  20,  10,   0,   o, o, o, o, o, o, o, o
  ...
  function isDoublePawn(square, color) {
    if (board[square - specialMoves.color[color].target] != specialMoves.color[color].pawn) return 0;
    if (board[square + 1 - specialMoves.color[color].target] == specialMoves.color[color].pawn) return 0;
    if (board[square - 1 - specialMoves.color[color].target] == specialMoves.color[color].pawn) return 0;
  ...
  function isIsolatedPawn(square, color) {
    if (isolatedPawnMask[color][(square & 7) + 1] == specialMoves.color[color].pawn) return 0;
    if (isolatedPawnMask[color][(square & 7) - 1] == specialMoves.color[color].pawn) return 0;
  ...
  function isBackwardPawn(square, color) {
    if (color) {
      for (let rank = square >> 4; rank >= 0; rank--) {
        if (board[rank * 16 + (square & 7) + 1] == specialMoves.color[color].pawn) return 0;
        if (board[rank * 16 + (square & 7) - 1] == specialMoves.color[color].pawn) return 0;
      }
    } else {
  ...
  function getPassedPawnBonus(square, color) {
    if (color) {
      for (let rank = square >> 4; rank < 8; rank++) {
        if (board[rank * 16 + (square & 7)] == specialMoves.color[color ^ 1].pawn) return 0;
        if (board[rank * 16 + (square & 7) + 1] == specialMoves.color[color ^ 1].pawn) return 0;
        if (board[rank * 16 + (square & 7) - 1] == specialMoves.color[color ^ 1].pawn) return 0;
      }
    } else {
      for (let rank = square >> 4; rank >= 0; rank--) {
    ...
    return rank[color] * passedPawnBonus;
  }
  ...
  function evaluate() {
    ...
    for (let piece = P; piece <= k; piece++) {
      for (pieceIndex = 0; pieceIndex < pieceList[piece]; pieceIndex++) {
        ...
        switch (piece) {
          case P:
            score += pstPawn[square];
            score -= isDoublePawn(square, white) * doublePawnPenalty;
            score -= isIsolatedPawn(square, white) * isolatedPawnPenalty;
            score -= isBackwardPawn(square, white) * backwardPawnPenalty;
            score += getPassedPawnBonus(square, white);
            break;
          ...
          case p:
            score -= pstPawn[mirrorSquare[square]];
            score += isDoublePawn(square, black) * doublePawnPenalty;
            score += isIsolatedPawn(square, black) * isolatedPawnPenalty;
            score += isBackwardPawn(square, black) * backwardPawnPenalty;
            score -= getPassedPawnBonus(square, black);
            break;
  ...
  function debug() {
    ...
    setBoard('8/8/p3p3/3p1p2/3P1P2/4P2P/8/8 w -- 0 0 ');
    updateBoard();
    evaluate();
  }
